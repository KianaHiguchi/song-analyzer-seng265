 ...
 *
 * This function deallocates the memory allocated for each node
 * and the data it contains in the linked list, starting from the
 * provided head.
 *
 ...
 *
 * This function reverses the order of a linked list by modifying the next pointers
 * of each node.
 *
 * @param head Pointer to the head of the linked list to be reversed.
